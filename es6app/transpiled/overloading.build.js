...
function Students() {
  ...
  overload(this, "find", function (status) {
    return students.filter(function (s, i) {
...
console.log("All Students ".concat(JSON.stringify(result)));
console.log();
var passStudents = students.find('Passed');
console.log("Passed Students ".concat(JSON.stringify(passStudents)));
